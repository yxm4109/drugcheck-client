...
package net.ucopy.drugcheck.zxinglib.view;
...
import net.ucopy.drugcheck.zxinglib.R;
import net.ucopy.drugcheck.zxinglib.camera.CameraManager;
import net.ucopy.drugcheck.zxinglib.decoding.CaptureActivityHandler;
import net.ucopy.drugcheck.zxinglib.decoding.InactivityTimer;
